...
const menuItems = [
  ...
  { href: '/anomaly-detection', label: 'AI Detection', icon: AlertTriangle, badge: 'AI' },
];
...
export function SessionNavBar() {
  ...
  return (
    <div 
      className={`fixed left-0 top-0 z-50 h-full flex flex-col transition-all duration-300 ease-in-out shadow-2xl ${
