    ...
    <div className="space-y-6">
      ...
      {activeSubSection === 'Performance' && (
        <div className="bg-white p-6 rounded-xl shadow-lg border border-slate-100 dark:bg-slate-800 dark:border-slate-700">
          <h2 className="text-xl font-semibold text-slate-700 dark:text-slate-200 mb-4">Performance Metrics</h2>
          <p className="text-slate-600 dark:text-slate-400">This section will display detailed performance metrics, comparisons, and efficiency reports. (Content TBD)</p>
        </div>
      )}
      {activeSubSection === 'Analytics' && (
         <div className="bg-white p-6 rounded-xl shadow-lg border border-slate-100 dark:bg-slate-800 dark:border-slate-700">
          <h2 className="text-xl font-semibold text-slate-700 dark:text-slate-200 mb-4">Advanced Analytics</h2>
          <p className="text-slate-600 dark:text-slate-400">This section will feature advanced analytics, predictive modeling, and anomaly detection insights. (Content TBD)</p>
        </div>
      )}
      {activeSubSection === 'UnitDetails' && (
        <div className="bg-white p-6 rounded-xl shadow-lg border border-slate-100 dark:bg-slate-800 dark:border-slate-700">
          <h2 className="text-xl font-semibold text-slate-700 dark:text-slate-200 mb-4">Unit Details & Consumption Breakdown</h2>
          <p className="text-slate-600 dark:text-slate-400">This section will provide a detailed breakdown of consumption per unit, historical data views, and individual unit management tools. (Content TBD)</p>
        </div>
      )}
